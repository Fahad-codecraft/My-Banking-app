  ...
  return (
    <section className='auth-Form'>
      <header className='flex flex-col gap-5 md:gap-8'>
        <Link
          href='/' className="cursor-pointer items-center gap-1 flex"
        >
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            {type === 'sign-up' && (
              <>
                ...
                <div className="flex gap-4">
                  <CustomInput
                    control={form.control} name='state' label="State" placeholder="Example: Maharashtra" />
                  <CustomInput
                    control={form.control} name='postalCode' label="Postal Code" placeholder="Example: 400001" />
                </div>
                <div className="flex gap-4">
                  <CustomInput
